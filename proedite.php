  ...
  <a class="btn btn-success" style="width: 10%;float:right" href="<?php $_SERVER['PHP_SELF'];?>" class="alert-link"> <i class="fa fa-refresh"></i>  Refresh </a> 
      ...
      <?php 
          ...
          include('php/docase.php');
                    ...
                    $sql1 = $db->prepare("SELECT * FROM doprocess WHERE disputeNo = '$id'");
                    $sql1->execute();
        ...
        $resultdate = $_POST['resultdate'];
            ...
            ?>
               <div class="alert alert-success" role="alert">
                Chairman of Z.I Asmeer Process Success  ...If Click <a href="proview.php" class="alert-link">Here</a>.You can See Process Datas....<br>  
                </div>
            <?php
        }
